...
const sampleProducts = [
  {
    ...
    images: {
      main: { 
        ...
        publicId: "rolex-submariner-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop", publicId: "rolex-submariner-1" },
        { url: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop", publicId: "rolex-submariner-2" }
      ]
    }
  },
  {
    ...
    images: {
      main: { 
        ...
        publicId: "omega-speedmaster-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop", publicId: "omega-speedmaster-1" },
        { url: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop", publicId: "omega-speedmaster-2" }
      ]
    }
  },
  {
    ...
    images: {
      main: { 
        url: "https://images.unsplash.com/photo-1524592714765-34b70c2a8245?w=800&h=800&fit=crop",
        publicId: "patek-nautilus-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1524592714765-34b70c2a8245?w=400&h=400&fit=crop", publicId: "patek-nautilus-1" },
        { url: "https://images.unsplash.com/photo-1524592714765-34b70c2a8245?w=400&h=400&fit=crop", publicId: "patek-nautilus-2" }
      ]
    }
  },
  {
    ...
    images: {
      main: { 
        url: "https://images.unsplash.com/photo-1515377909964-cea7111295a7?w=800&h=800&fit=crop",
        publicId: "tagheuer-carrera-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1515377909964-cea7111295a7?w=400&h=400&fit=crop", publicId: "tagheuer-carrera-1" },
        { url: "https://images.unsplash.com/photo-1515377909964-cea7111295a7?w=400&h=400&fit=crop", publicId: "tagheuer-carrera-2" }
      ]
    }
  },
  {
    ...
    images: {
      main: { 
        url: "https://images.unsplash.com/photo-1598393004018-4db5aba7544c?w=800&h=800&fit=crop",
        publicId: "breitling-navitimer-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1598393004018-4db5aba7544c?w=400&h=400&fit=crop", publicId: "breitling-navitimer-1" },
        { url: "https://images.unsplash.com/photo-1598393004018-4db5aba7544c?w=400&h=400&fit=crop", publicId: "breitling-navitimer-2" }
      ]
    }
  },
  {
    ...
    images: {
      main: { 
        url: "https://images.unsplash.com/photo-1549692520-59acee642fe2?w=800&h=800&fit=crop",
        publicId: "ap-royal-oak-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1549692520-59acee642fe2?w=400&h=400&fit=crop", publicId: "ap-royal-oak-1" },
        { url: "https://images.unsplash.com/photo-1549692520-59acee642fe2?w=400&h=400&fit=crop", publicId: "ap-royal-oak-2" }
      ]
    }
  },
  {
    ...
    images: {
      main: { 
        ...
        publicId: "seiko-prospex-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400&h=400&fit=crop", publicId: "seiko-prospex-1" },
        { url: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400&h=400&fit=crop", publicId: "seiko-prospex-2" }
      ]
    }
  },
  {
    ...
    images: {
      main: { 
        ...
        publicId: "jlc-master-main"
      },
      gallery: [
        { url: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=400&fit=crop", publicId: "jlc-master-1" },
        { url: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=400&fit=crop", publicId: "jlc-master-2" }
      ]
    }
  }
];
...
async function seedProducts() {
  ...
  try {
    ...
    console.log(`   Más económico: $${Math.min(...prices).toLocaleString()}`);
    console.log(`   Más caro: $${Math.max(...prices).toLocaleString()}`);
